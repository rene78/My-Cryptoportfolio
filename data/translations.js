...
const translations = {
  ...
  "change-perc": [["Change ", "Change in percent in the last 24h. Click here to sort"], ["Diff. % ", "Änderung in Prozent innerhalb der letzten 24h. Hier klicken, um alphabetisch zu sortieren"]],
  "gain-loss-24h": [["G/L (24h) ", "Gain/loss in the last 24h. Click here to sort"], ["G/V (24h) ", "Gewinn/Verlust in Fiat innerhalb der letzten 24h. Hier klicken, um alphabetisch zu sortieren"]],
  "gain-loss": [["Gain / Loss ", "Overall gain/loss. Click here to sort"], ["G/V ", "Gesamter Gewinn/Verlust. Hier klicken, um alphabetisch zu sortieren"]],
  //Chart
...
const translFAQ = {
  ...
  "question4":
    ['<summary><h2>Can I support the development?</h2></summary><p>This would be very much appreciated! There are four ways:</p><ol><li>Leave your suggestions in the forum on this site</li><li>Even better: If you know some JS, HTML and CSS you can <a href="https://github.com/rene78/My-Cryptoportfolio">improve the app</a></li><li>Help to translate the app to your mother tongue</li><li>You can send me a tip. Bitcoin address: 13kGpAVk87XGRDm6ZscUFvGaTFyjPuKLTY </li></ol>',
      '<summary><h2>Kann ich die Entwicklung unterstützen?</h2></summary><p>Das wäre sehr willkommen! Es gibt vier Möglichkeiten:</p><ol><li>Veröffentliche deine Vorschläge im Forum auf dieser Seite.</li><li>Besser: Falls Du ein wenig JS, HTML und CSS beherrschst, kannst Du <a href="https://github.com/rene78/My-Cryptoportfolio">die App verbessern</a></li><li>Hilf dabei, die App in eine andere Sprache zu übersetzen</li><li>Du kannst mir einen kleines Trinkgeld schicken. Bitcoin address: 13kGpAVk87XGRDm6ZscUFvGaTFyjPuKLTY </li></ol>'],
  "question5":
    ['<summary><h2>Where are the coin prices coming from?</h2></summary><p>From the <a href="https://min-api.cryptocompare.com/">Cryptocampare API</a>. The prices are an average value of all well-known crypto exchanges.</p>',
      '<summary><h2>Wo kommen die Coinpreise her?</h2></summary><p>Von der <a href="https://min-api.cryptocompare.com/">Cryptocampare API</a>. Die Kurse sind ein Mittelwert aller namhaften Kryptobörsen.</p>'],
  "question6":
