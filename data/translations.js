...
const translFAQ = {
  ...
  "question4":
    ['<summary><h2>Can I support the development?</h2></summary><p>This would be very much appreciated! There are four ways:</p><ol><li>Leave your suggestions in the forum on this site</li><li>Even better: If you know some JS, HTML and CSS you can <a href="https://github.com/rene78/My-Cryptoportfolio">improve the app</a></li><li>Help to <a href="https://github.com/rene78/My-Cryptoportfolio/tree/master/data#translate">translate the app to your mother tongue</a></li><li>Currently Microsoft Azure wants an exploitative 0.40€/year for hosting the site. Help me to cover these immense costs <div class="tallypay" data-user="rene78" data-size="button" data-button_text="Donate via Lightning" ></div> </li></ol>',
