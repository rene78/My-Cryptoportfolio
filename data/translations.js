...
const translFAQ = {
  ...
  "question4":
    ['<summary><h2>Can I support the development?</h2></summary><p>This would be very much appreciated! There are four ways:</p><ol><li>Leave your suggestions in the forum on this site</li><li>Even better: If you know some JS, HTML and CSS you can <a href="https://github.com/rene78/My-Cryptoportfolio">improve the app</a></li><li>Help to translate the app to your mother tongue</li><li>Currently Microsoft Azure wants an exploitative 0.40€/year for hosting the site. Help me to cover these immense costs. <div class="tallypay" data-user="rene78" data-size="button" data-button_text="Donate" ></div> </li></ol>',
      '<summary><h2>Kann ich die Entwicklung unterstützen?</h2></summary><p>Das wäre sehr willkommen! Es gibt vier Möglichkeiten:</p><ol><li>Veröffentliche deine Vorschläge im Forum auf dieser Seite.</li><li>Besser: Falls Du ein wenig JS, HTML und CSS beherrschst, kannst Du <a href="https://github.com/rene78/My-Cryptoportfolio">die App verbessern</a></li><li>Hilf dabei, die App in eine andere Sprache zu übersetzen</li><li>Momentan will Microsoft Azure ausbeuterische 0.40€/Jahr für das Hosten der Seite. Hilf mir doch beim Decken dieser immensen Kosten. <div class="tallypay" data-user="rene78" data-size="button" data-button_text="Spende via Lightning" ></div> </li></ol>'],
  "question5":
