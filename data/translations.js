...
const translFAQ = {
  ...
  "question4":
    ['<summary><h2>Can I support the development?</h2></summary><p>This would be very much appreciated! There are three ways:</p><ol><li>Leave your suggestions in the forum on this site</li><li>Even better: If you know some JS, HTML and CSS you can <a href="https://github.com/rene78/My-Cryptoportfolio">improve the app</a></li><li>Help to <a href="https://github.com/rene78/My-Cryptoportfolio/tree/master/data#translate">translate the app to your mother tongue</a></li></ol>',
      '<summary><h2>Kann ich die Entwicklung unterstützen?</h2></summary><p>Das wäre sehr willkommen! Es gibt drei Möglichkeiten:</p><ol><li>Veröffentliche deine Vorschläge im Forum auf dieser Seite.</li><li>Besser: Falls Du ein wenig JS, HTML und CSS beherrschst, kannst Du <a href="https://github.com/rene78/My-Cryptoportfolio">die App verbessern.</a></li><li>Hilf dabei, die App in eine andere Sprache zu <a href="https://github.com/rene78/My-Cryptoportfolio/tree/master/data#translate">übersetzen.</a></li></ol>'],
  "question5":
